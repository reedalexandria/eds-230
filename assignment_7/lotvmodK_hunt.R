...
#' @param pars datatype list  coefficient in Lotka-Voltera pars$rprey, pars$alpha, pars$eff, par$pmort, pars$h
...
#'  \emph{hunting} is a rate of hunting
#' @examples
#' lotvmodK_hunt(t=1, pop=list(1,2), pop=list(0.5,0.3,0.2,0.2))
#'
#' pars = c(rprey=0.5, alpha=0.3, eff=0.2, pmort=0.2, h = 0.5)
